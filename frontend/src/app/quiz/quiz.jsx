...
export default function Quiz({ locations }) {
  ...
  const lockIn = () => {
    ...
    const distance_metres = 1000 * haversine(answerLat, answerLong, selectedPos.lat, selectedPos.lng);
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <MapContainer center={unswCoordinates} zoom={16} minZoom={16} maxZoom={18} zoomDelta={0.2} style={{ height: '600px', width: '800px' }}>
        <TileLayer
      ...
      <div className="flex flex-col">
        ...
        <div className='flex flex-col items-center mx-auto mt-4'>
          {selectedPos && !answerRevealed && UNSWLocations && UNSWLocations.length > 0 &&
            <button onClick={lockIn} className="btn btn-primary w-1/2 mb-5">Lock In</button>
          }
          {
            answerRevealed && 
